...
export class DetailsComponent implements OnInit {
    ...
    this.route.queryParams
      ...
      .subscribe(
        (trainingSession: TrainingSession[]) => {
          ...
          this.userConfigurationForUI = new MatTableDataSource(
  ...
  viewTrainingResults(trainingSessionId: string) {
    this.router.navigate(["/users/trainingresults"], {
      queryParams: { q: trainingSessionId },
    });
  }
}
